    ...
    <div className="flex-shrink-0 h-full w-[300px] p-5 bg-blue-400 rounded-xl ">
      ...
      <div className="mt-4">
        <button
          ...
          className="w-full bg-emerald-500 rounded"
        >
          Accept Task
        </button>
      {data.forwardedBy?<div className="mt-2 w-full bg-puple-600 rounded"> Forwarded by: {data.forwardedBy}</div>: ''}      
      </div>
      <div className="mt-2">
      <form 
      ...
      >
          ...
          <div className='w-1/2 flex flex-col items-start'>  
            <button
            className="w-full bg-purple-600 rounded"
            >
            Forward Task
            </button>
          </div>
